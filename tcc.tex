...
\autordois{Everton Leandro Baroni}
%\autordois{Autor 2}%use se necessário

%======Título do trabalho (Português e Inglês)
\titulo{Custos para se iniciar um Comércio Eletrônico}
%\title{Work Title}
...
\comentario{Trabalho entregue ao Prof. Àlamo Alexandre, ministrante da disciplina de 
